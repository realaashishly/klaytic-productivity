...
import { ExternalLink, Plus, X, Folder, FolderOpen, ArrowRight, Trash2 } from 'lucide-react';
import { LinkResource } from '../types';
import { getLinks, createLink, deleteLink } from '@/actions/linkActions';
...
const Links: React.FC = () => {
  ...
  if (loading) {
    return <div className="p-12 text-center text-neutral-500 font-mono animate-pulse">LOADING NODES...</div>;
  }
